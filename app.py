...
csp = {
    ...
    'script-src': ["'self'", "'unsafe-inline'", "'unsafe-eval'", "blob:", "https://cdn.jsdelivr.net", "https://cdnjs.cloudflare.com", "https://binaries.soliditylang.org", "https://static.cloudflareinsights.com", "https://esm.sh"],
