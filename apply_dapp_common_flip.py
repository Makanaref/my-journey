with open("templates/flip.html", "r", encoding="utf-8") as f:
    content = f.read()
...
# 2. Remove the duplicated `networks` object (now provided by dapp-common.js as NETWORKS)
...
with open("templates/flip.html", "w", encoding="utf-8") as f:
    f.write(content)

print("Done. flip.html now uses shared dapp-common.js for networks.")
